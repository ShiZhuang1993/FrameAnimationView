...
public class BitmapLoadUtil {
     ...
     * 读取图片 优先从缓存中获取图片
     */
    static BitmapDrawable decodeBitmapFromResLruCache(Resources resources, int resId,
    ...
    private static BitmapDrawable readBitmapFromRes(Resources resources, int resId, ImageCache cache, BitmapFactory.Options options) {
        addInBitmapOptions(options, cache);
        options.inJustDecodeBounds = false;
